...
<h2> 수업 검색 </h2>
    ...
    %>
<div>
    <form method="post" action="student_searchClass.jsp">
        <input type="text" class="form-control" placeholder="수업 ID", name="class_id">
        <input type="text" class="form-control" placeholder="과목 ID" name="course_id">
        <input type="text" class="form-control" placeholder="교과목 명" name="name">
